...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a <span className="text-AAsecondary">Full stack web developer</span>, i possess strong problem-solving skills and
        specialize in crafting exceptional <br className="2xl:block hidden" />
        web experiences. My current area of focus is in the <span className="text-AAsecondary">web development</span>,
        ...
        <span className="text-AAsecondary">React</span>  on the{" "}
