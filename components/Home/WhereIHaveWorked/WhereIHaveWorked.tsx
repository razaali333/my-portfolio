...
import Aursoft from "./Descriptions/Aursoft";
import Ferisoft from "./Descriptions/Ferisoft";
import Fujtown from "./Descriptions/Fujtown";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Aursoft");
  return (
