...
export default function AboutMe(props) {
  const technologies = [
    ["Next.js", "JavaScript (ES6+)", "Tailwind CSS", "Solidity","Firebase"],
    ["Node.js", "TypeScript", "Framer Motion", "vuejs", "laravel","mongoDB"],
  ];
  return (
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Raza Ali, and I am a passionate software engineer and problem solver, dedicated to
                creating impactful codes that thrive on the internet. My journey in computer science began in 2015 when
                I delved into the world of Web Development using PHP. Little did I know that programming skills
            ...
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                <span className="text-AAsecondary">React</span>, I am dedicated to pushing boundaries and driving
                advancements. With experience working alongside esteemed organizations like{" "}
                <span className="text-AAsecondary">Fujtown</span> , my passion for web and continuous
